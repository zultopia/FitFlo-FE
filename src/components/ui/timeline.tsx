...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full h-full from-white to-[#A3D6DC] dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}
    >
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-primary dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
